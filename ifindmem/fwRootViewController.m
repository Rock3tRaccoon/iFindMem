...
- (void)viewDidLoad {
    ...
    UIAlertAction *pidAlertOk = [UIAlertAction actionWithTitle:@"Add" style:UIAlertActionStyleDefault handler:^(UIAlertAction * action) {
        ...
        if ([[self.pidAlert textFields][0] hasText]) {
            ...
            if (self.task != MACH_PORT_NULL) {
                ...
                UIAlertController *failalert = [UIAlertController alertControllerWithTitle:@"ERROR" message:[NSString stringWithFormat:@"task_for_pid(%i) failure!\n\nEither you don't have correct entitlements for iFindMem, are trying to obtain task_for_pid(0), or inputted an invalid process ID", self.pid] preferredStyle:UIAlertControllerStyleAlert];
    ...
    NSString *aboutMessage = @"iFindMem is a DEVELOPER program that searches for bytes or strings inside of memory and prints out the results. This is useful for patching binaries and items inside of memory.\n\nTo find a process ID, type 'ps ax' inside of NewTerm or an equivalent application and enter your desired process ID under 'iFindMem Controls'";
    self.aboutAlert = [UIAlertController alertControllerWithTitle:@"What is iFindMem?" message:aboutMessage preferredStyle:UIAlertControllerStyleAlert];
...
-(void) searchButtonPressed:(id)sender {
    ...
    if (sret != SEARCH_SUCCESS) {
        UIAlertController *erroralert = [UIAlertController alertControllerWithTitle:@"iFindMem Error" message:[NSString stringWithFormat:@"Search Error:\n\n%@", [self searchTypeToString:sret]] preferredStyle:UIAlertControllerStyleAlert];
        ...
        UIAlertController *successalert = [UIAlertController alertControllerWithTitle:@"iFindMem Search" message:[NSString stringWithFormat:@"Total Found: %i", self.resultnum] preferredStyle:UIAlertControllerStyleAlert];
        UIAlertAction *aboutAlertOk = [UIAlertAction actionWithTitle:@"Ok" style:UIAlertActionStyleDefault handler:nil];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    UIAlertAction *actionOk = [UIAlertAction actionWithTitle:@"Write" style:UIAlertActionStyleDefault handler:^(UIAlertAction * action) {
    		...
    		if (sret != WRITE_SUCCESS) {
                UIAlertController *erroralert = [UIAlertController alertControllerWithTitle:@"iFindMem Error" message:[NSString stringWithFormat:@"Write Error:\n\n%@", [self searchTypeToString:sret]] preferredStyle:UIAlertControllerStyleAlert];
                UIAlertAction *aboutAlertOk = [UIAlertAction actionWithTitle:@"Ok" style:UIAlertActionStyleDefault handler:nil];
                [erroralert addAction:aboutAlertOk];
        		[self presentViewController:erroralert animated:YES completion:nil];
        		[self.window setWindowLevel:[self.window windowLevel] -1];
                ...
                UIAlertController *successalert = [UIAlertController alertControllerWithTitle:@"iFindMem Write" message:[NSString stringWithFormat:@"Write Success!\n\nWrote 0x%@ to address %@", [[writeAlert textFields][0] text], cell.textLabel.text] preferredStyle:UIAlertControllerStyleAlert];
                UIAlertAction *aboutAlertOk = [UIAlertAction actionWithTitle:@"Ok" style:UIAlertActionStyleDefault handler:nil];
                [successalert addAction:aboutAlertOk];
        		[self presentViewController:successalert animated:YES completion:nil];
        		[self.window setWindowLevel:[self.window windowLevel] -1];
